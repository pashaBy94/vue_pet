<script setup>
import { BUTTON_TYPE_DANGER, PERIOD_SELECT_OPTIONS } from '../utils/constants'
import { ICON_TRASH } from '../utils/icons'
import { isActivityValid } from '../utils/validators'
import { updateActivity, deleteActivity } from '../utils/activities'
import { timelineItems, resetTimelineItemActivities } from '../utils/timeline-items'
